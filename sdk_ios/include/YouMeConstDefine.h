...
typedef enum YouMeEvent {
    ...
    YOUME_EVENT_OTHERS_CAMERA_PAUSE            = 202, ///< 其他用户摄像头暂停
    YOUME_EVENT_OTHERS_CAMERA_RESUME           = 203, ///< 其他用户摄像头恢复
